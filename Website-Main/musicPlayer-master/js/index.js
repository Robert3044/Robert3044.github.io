$(function(){
    ...
    var musicImgsData = ['img/bg1.jpg','img/bg.jpg','img/bg2.jpg']    // 图片地址数组
    var musicNameData = ['Water (Original Mix)','Work from Home','归去来兮'];                   // 歌曲名数组
    var artistNameData = ['LeeAlive','Fifth Harmony _ Ty Dolla $ign','花粥']            // 创作歌手数组
    var musicUrls=['mp3/music2.mp3','mp3/music1.mp3','mp3/music3.mp3'];// 歌曲mp3数组
